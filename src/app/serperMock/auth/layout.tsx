...
import { ThemeToggle } from '@/components/MyHeader'

interface NavItem {
  id: number
  name: 'Dashboard' | 'Playground' | 'API key' | 'Logs' | 'Billing'
  href: string
...
export default function AuthLayout({
  ...
  const navigation: NavItem[] = [
    { id: 1, name: 'Dashboard', href: 'dashboard', icon: ChartBarIcon },
    { id: 1, name: 'Playground', href: 'playground', icon: CodeBracketIcon },
    { id: 1, name: 'API key', href: 'api-key', icon: KeyIcon },
    { id: 1, name: 'Logs', href: 'logs', icon: ClipboardDocumentListIcon },
    { id: 1, name: 'Billing', href: 'billing', icon: WalletIcon },
  ]
  ...
  return (
    <div className="flex w-full">
      <Transition show={sidebarOpen}>
        <Dialog className="relative z-50 lg:hidden" onClose={setSidebarOpen}>
          <TransitionChild
            ...
            leaveTo="opacity-0"
          >
            <div className="fixed inset-0 bg-zinc-100/60 dark:bg-zinc-900/80" />
          </TransitionChild>
          ...
          <div className="fixed inset-0 flex">
            ...
            >
              <DialogPanel className="relative mr-16 flex w-full max-w-xs flex-1 shadow">
                <TransitionChild
                ...
                <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-zinc-100 px-6 pb-4 ring-1 ring-zinc-100/10 dark:bg-zinc-900">
                    ...
                    >
                      <li>
                        <ul role="list" className="-mx-2 space-y-1">
                          {navigation.map((item: NavItem) => (
                            <button className="w-full" key={item.name}>
                              <a
                                href={item.href}
                      ...
                      <li className="mt-auto">
                        ...
                        <Menu as="div" className="w-full">
                          <MenuButton className="mt-auto w-full">
                            ...
                            >
                              <img
                                ...
                                src="https://4kwallpapers.com/images/wallpapers/satoru-gojo-jujutsu-1280x1280-9292.jpg"
                                alt=""
                              />
                              ...
                              <div className="flex w-full flex-col">
                                <span
                                  aria-hidden="true"
                                  className="line-clamp-1 w-full text-start text-sm font-semibold leading-5 dark:text-zinc-100"
                                >
                                  Punnawat Lohanuit Nicepun_
                                </span>
                                <span
                                  aria-hidden="true"
                                  className="line-clamp-1 w-full text-start text-xs font-normal leading-5 dark:text-zinc-400"
                                >
                                  Pun58000@gmail.com
                                </span>
                              </div>
                          ...
                          >
                            <MenuItems className="absolute bottom-20 left-4 z-10 mt-2 w-56 origin-top-right divide-y divide-zinc-100 rounded-md bg-zinc-200 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none dark:divide-zinc-900 dark:bg-zinc-800">
                              <div className="py-1">
                                <MenuItem>
                                  {({ focus }) => (
                                    <a
      ...
      <div className="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-[262px] lg:flex-col">
        {/* Sidebar component, swap this element with another sidebar if you like */}
        <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-zinc-100 px-6 pb-4 dark:bg-zinc-900">
          <div className="flex h-16 shrink-0 items-end">
            <div className="flex h-10 w-full flex-row justify-between">
      ...
      <div className="w-full overflow-y-scroll lg:pl-[262px]">
        <div className="sticky top-0 z-40 flex h-[72px] shrink-0 flex-row-reverse items-center gap-x-4 border-b bg-zinc-100/[0.96] px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:hidden lg:px-8 dark:border-zinc-600 dark:bg-zinc-800">
          ...
          {/* Separator */}
          <div
            className="h-6 w-px bg-zinc-100/10 bg-zinc-200 lg:hidden dark:bg-zinc-900"
            aria-hidden="true"
          />
